    ...
    return const Column(
      ...
      children: [
        _StepTile(
          ...
          subtitle: 'Создайте аккаунт и настройте способ оплаты.',
        ),
        SizedBox(height: 8),
        _StepTile(
          title: 'Шаг 2. Оплачивайте легко',
          subtitle: 'Платите за участие и услуги в пару кликов.',
        ),
        SizedBox(height: 8),
        _StepTile(
          title: 'Шаг 3. Получайте подтверждения',
          subtitle: 'Сразу видите статус оплаты и чек.',
        ),
      ],
    );
  }
