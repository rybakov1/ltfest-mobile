  ...
  return Column(
    ...
    children: [
      Row(
        crossAxisAlignment: CrossAxisAlignment.end,
        children: [
          // ВСЕГДА показываем поле промокода, независимо от роли
          Expanded(
            child: buildTextField(
              controller: promocodeController,
              label: "Промокод",
          ...
          ValueListenableBuilder<TextEditingValue>(
            valueListenable: promocodeController,
            builder: (context, promoValue, child) {
              final bool isButtonActive = promoValue.text.isNotEmpty;
              ...
              return InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8),
                    color: isButtonActive ? Palette.primaryLime : Palette.stroke,
                  ),
                  child: Icon(Icons.arrow_forward_outlined,
                      color: Palette.white, size: 24),
                ),
